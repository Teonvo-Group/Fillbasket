            ...
            <nav className="navbar navbar-light bg-white navbar-expand-xl">
              ...
              <div className="collapse navbar-collapse bg-white" id="navbarCollapse">
                <div className="navbar-nav mx-auto">
                  ...
                  <a href="/Shopr" className="nav-item nav-link active">
                    Shop Detail
                  </a>
          ...
          <div className="container py-5">
            <div className="row g-4 align-items-center">
              <div className="col-lg-6">
                <div className="py-4">
                  <h1 className="display-3 text-white">Your Shop is not register yet</h1>
                  <p className="fw-normal display-3 text-dark mb-4">Regsiter Your Shop Now</p>
                  ...
                  <a href="/admin" className="banner-btn btn border-2 border-white rounded-pill text-dark py-3 px-5">Register Now</a>
                </div>
              </div>
              <div className="col-lg-6">
                <div className="position-relative">
                  <img src="images/shopr2.avif" className="img-fluid w-100 rounded" alt="" />
                  {/* <div className="d-flex align-items-center justify-content-center bg-white rounded-circle position-absolute" style={{"width":"140px","height":"140px","bottom":"0","left":"0"}}>
